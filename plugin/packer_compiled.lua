...
_G.packer_plugins = {
  ...
  vimwiki = {
    config = { "\27LJ\2\nå\1\0\0\3\0\3\0\0056\0\0\0009\0\1\0'\2\2\0B\0\2\1K\0\1\0m let g:vimwiki_list = [{'path': '~/vimwiki', 'diary_rel_path': '', 'syntax': 'markdown', 'ext': '.md'}] \bcmd\bvim\0" },
    loaded = true,
    path = "/Users/cdkini/.local/share/nvim/site/pack/packer/start/vimwiki",
...
try_loadstring("\27LJ\2\nå\1\0\0\3\0\3\0\0056\0\0\0009\0\1\0'\2\2\0B\0\2\1K\0\1\0m let g:vimwiki_list = [{'path': '~/vimwiki', 'diary_rel_path': '', 'syntax': 'markdown', 'ext': '.md'}] \bcmd\bvim\0", "config", "vimwiki")
