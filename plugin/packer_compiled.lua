...
pcall(vim.cmd, [[command -nargs=* -range -bang -complete=file Startify lua require("packer.load")({'vim-startify'}, { cmd = "Startify", l1 = <line1>, l2 = <line2>, bang = <q-bang>, args = <q-args>, mods = "<mods>" }, _G.packer_plugins)]])
